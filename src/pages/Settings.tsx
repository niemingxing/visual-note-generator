...
export function Settings() {
  const {
    ...
    setProvider, setApiKey, setVolcengineApiKey, setVolcengineChatModel, setVolcengineImageModel, clearApiKey
  } = useSettingsStore();
  ...
  }, [apiKey, volcengineApiKey, volcengineChatModel, volcengineImageModel]);
  ...
  const handleVolValidate = async () => {
    ...
    if (valid) {
      ...
      setVolcengineImageModel(volImageModel.trim() || 'doubao-seedream-3-0');
    }
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-2xl px-4 py-8">
        ...
        <div className="flex gap-1 mb-6 p-1 bg-muted rounded-lg w-fit">
          ...
          <button
            onClick={() => handleTabChange('volcengine')}
            className={cn(
              'px-4 py-2 rounded-md text-sm font-medium transition-colors',
